...
#     ok_(acc > .86, "Accuracy Obt: " + str(acc))
#
# def test_model_Crf_en_dev_accuracy1():
#     confusion = scorer.get_confusion(DEV_FILE,'../model_crf-dev-en.preds')
#     acc = scorer.accuracy(confusion)
#     ok_(acc > .86,"Accuracy Obt: "+str(acc))
#
# def test_model_crf_nr_dev_accuracy1():
#     confusion = scorer.get_confusion(NR_DEV_FILE,'../model_crf-dev-nr.preds')
#     acc = scorer.accuracy(confusion)
#     ok_(acc > .86, "Accuracy Obt: " + str(acc))
...
# bilstm_crf-dev-en.preds
# bilstm_crf-dev-nr.preds
# bilstm-dev-en.preds
# bilstm-dev-nr.preds
